...
class stat_landmark_crime(dml.Algorithm):
    ...
    reads = ['soohyeok_soojee.get_neighborhoods', 'soohyeok_soojee.kmeans_landmark_crime']
    writes = ['soohyeok_soojee.stat_landmark_crime']
    ...
    def execute(trial = False):
        ...
        repo.dropCollection("stat_landmark_crime")
        repo.createCollection("stat_landmark_crime")
        repo['soohyeok_soojee.stat_landmark_crime'].insert_many(result)
        repo['soohyeok_soojee.stat_landmark_crime'].metadata({'complete':True})
    ...
    def provenance(doc = prov.model.ProvDocument(), startTime = None, endTime = None):
        ...
        this_script = doc.agent('alg:soohyeok_soojee#stat_landmark_crime', {prov.model.PROV_TYPE:prov.model.PROV['SoftwareAgent'], 'ont:Extension':'py'})
        ...
        resource_kmeans = doc.entity('dat:soohyeok_soojee#kmeans_landmark_crime', {prov.model.PROV_LABEL:'kmeans_landmark_crime', prov.model.PROV_TYPE:'ont:DataSet'})
        ...
        stat = doc.entity('dat:soohyeok_soojee#stat_landmark_crime', {prov.model.PROV_LABEL:'stat_landmark_crime', prov.model.PROV_TYPE:'ont:DataSet'})
...
# stat_landmark_crime.execute()
# doc = stat_landmark_crime.provenance()
# print(doc.get_provn())
